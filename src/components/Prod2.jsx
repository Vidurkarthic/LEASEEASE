...
export default function Prod2() {
  ...
  const cardData = [
    { title: 'Leo Lounger Sofa', description: '1 year', price: 4500, image: 'https://p.rmjo.in/productSquare/v2zmo735-500x500.webp' },
    ...
    { title: 'Aurora Single Bed', description: 'Comfortable single bed', price: 1000, image: 'https://p.rmjo.in/productSquare/why0zew9-500x500.webp' },
    ...
    { title: 'Casper L-Shaped Sofa', description: 'L-shaped sofa', price: 4000, image: 'https://p.rmjo.in/productSquare/jhsspfzv-500x500.webp' },
  ...
  return (
    <div style={{ backgroundColor: '#323232'}}>
      ...
      <center style={{padding:'20px'}}>
        ...
        <h3 style={{ color: 'white', margin: '20px 0' }}>FURNITURES</h3>
